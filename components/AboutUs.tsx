      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1 rtl:md:order-2">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-[#AEAEAE]">{t.about.title}</h2>
            <div className="space-y-4 text-white md:text-lg">
              <p>{t.about.p1}</p>
              <p>{t.about.p2}</p>
            </div>
          </div>
          <div className="order-1 md:order-2 rtl:md:order-1">
            <img
              ...
              className="
    rounded-lg shadow-xl h-auto object-cover
    w-full md:w-[500px]
    md:mr-20
  "
            />
